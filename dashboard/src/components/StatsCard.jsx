    ...
    <div className="bg-dark-200 p-6 rounded-lg shadow-card-dark border border-gray-700">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center mt-2">
          <span className={`text-sm ${trend === 'up' ? (title.includes('Blocked') || title.includes('Suspicious') ? 'text-alert-high' : 'text-alert-low') : (title.includes('Health') ? 'text-alert-high' : 'text-alert-low')} flex items-center`}>
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
